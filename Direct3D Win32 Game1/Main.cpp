    ...
    case WM_SYSKEYDOWN:
        if (wParam == VK_RETURN && (lParam & 0x60000000) == 0x20000000)
        {
            ...
            if (s_fullscreen)
            {
                ...
                SetWindowPos(hWnd,static_cast<HWND>(nullptr), 0, 0, width, height, SWP_NOMOVE | SWP_NOZORDER | SWP_FRAMECHANGED); //HWND_TOP is 0
            }
            else
            {
                ...
                SetWindowPos(hWnd, static_cast<HWND>(nullptr), 0, 0, 0, 0, SWP_NOMOVE | SWP_NOSIZE | SWP_NOZORDER | SWP_FRAMECHANGED); //HWND_TOP
